# PolarDB PostgreSQL-Ops 参考文档

## 官方文档
- [DAS Agent 用户指南](https://help.aliyun.com/zh/das/user-guide/das-agent)
- [PolarDB PostgreSQL 产品文档](https://help.aliyun.com/product/14328.html)
...
4. **架构特性**: PolarDB PostgreSQL使用共享存储架构，不支持传统的主备切换记录查询